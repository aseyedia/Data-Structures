...
public class QuickSort {
	 ...
	 * @param left Left-most int
	 * @param right Right-most int
	...
	/**
	 * Prints entire array as well as sort type, elapsed time in nanoseconds and
	 * data file name to std out
	 * 
	 * @param arr Sorted array
	 * @param fileName Name of data file
	 * @param sortType Type of quicksort
	 * @param elapsedTime Time in nanoseconds of sort
	 * @param fileNum Number of files processed
	 * @throws IOException
	 * 
	 */
	public void printArray(int arr[], String fileName, int sortType,
		...
		PrintWriter print = new PrintWriter(
				new FileWriter("SortTimeOutput.txt", true));
		switch (sortType) {
		case 0:
